        ...
        <div class="row">
            ...
            <div class="card rounded-0">
                ...
                <div class="crad-footer">
                    ...
                    <div>
                        <form action="<?php echo ROOTURL; ?>/statuses/destroy/<?php echo $status->status_id; ?>" method="post">
                            <input type="submit" class="btn btn-danger btn-sm rounded-0" value="Delete">
                        </form>
                    </div>
                    <div>
                        <a href="<?php echo ROOTURL; ?>/statuses/edit/<?php echo $status->status_id; ?>" class="btn btn-success btn-sm rounded-0"></a>
                    </div>
                    <?php endif; ?>
                    
                    <div>
                        <a href="<?php echo ROOTURL; ?>/statuses/show/<?php echo $status->status_id; ?>" class="btn btn-success btn-sm rounded-0"></a>
                    </div>
                    </div>
                </div>
            </div>
